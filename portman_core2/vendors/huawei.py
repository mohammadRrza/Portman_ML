...
from .huawei_commands.ngn_delete_number import NGNDeleteNumber
...
from .huawei_commands.show_slot_port_by_mac import ShowPortByMac
from .huawei_commands.get_config import GetConfig
...
class Huawei(BaseDSLAM):
    ...
    command_factory.register_type('ngn_delete_number', NGNDeleteNumber)
    ...
    command_factory.register_type('show port with mac', ShowPortByMac)
