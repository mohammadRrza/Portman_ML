...
from .fiberhomeAN5006_commands.show_port_with_mac import ShowPortWithMac
from .fiberhomeAN5006_commands.show_up_time import ShowUpTime
from .fiberhomeAN5006_commands.get_config import GetConfig
...
class FiberhomeAN5006(BaseDSLAM):
    ...
    command_factory.register_type('show up time 5006', ShowUpTime)
